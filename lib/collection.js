 ...
 */
 ...
 var Collection = module.exports = require("./chainable").extend({
 	...
 	"update": function(selector, modifiers, options, next) {
 		...
 		this.next(function() {
 			self.target().update(selector, modifiers, options || {}, self._wrap(next || function(){}, this, function() {
 				self.emit("update", { selector: selector, modifiers: modifiers });
 			}));
 		});
 	},
 	...
 	"remove": function(selector, next) {
 		...
 		var self = this;
 		this.next(function() {
 			self.target().remove(selector, self._wrap(next || function(){}, this, function() {
